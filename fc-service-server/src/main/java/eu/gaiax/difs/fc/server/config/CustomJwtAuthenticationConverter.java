...
public class CustomJwtAuthenticationConverter implements Converter<Jwt,
  ...
  private Collection<? extends GrantedAuthority> extractResourceRoles(final Jwt jwt,
    ...
    if (resourceAccess != null && (resource = (Map<String, Object>) resourceAccess.get(
        resourceId)) != null
  ...
  public AbstractAuthenticationToken convert(final Jwt source) {
    Collection<GrantedAuthority> authorities = Stream.concat(
            this.jwtGrantedAuthoritiesConverter.convert(source)
                .stream(),
